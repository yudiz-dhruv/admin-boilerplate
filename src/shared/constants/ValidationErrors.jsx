...
export const validationErrors = {
  ...
  doctorNameRequired: <FormattedMessage id='requiredDoctorName' />,
  companyNameRequired: <FormattedMessage id='requiredCompanyName' />,
  ...
  TextForgotPasswordPage: <FormattedMessage id='forgotPasswordPageText' />,
  activeUsers: <FormattedMessage id='activeUsers' />,
  currentMonth: <FormattedMessage id='currentMonth' />,
  doctorAccounts: <FormattedMessage id='doctorAccounts' />,
  games: <FormattedMessage id='games' />,
  patients: <FormattedMessage id='patients' />,
  patientAccounts: <FormattedMessage id='patientAccounts' />,
